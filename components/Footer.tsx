...
export default function Footer() {
  return (
    <footer style={{ background: "var(--cream-warm)", color: "var(--teal)", borderTop: "1px solid var(--line)" }}>
      {/* Main footer */}
      <div style={{
        maxWidth: 1280,
        margin: "0 auto",
        ...
        {/* Brand */}
        <div>
          <Image src="/logo-circle.png" alt="Home Sweet Clean" width={100} height={100} style={{ marginBottom: 16 }} />
          <p style={{ fontSize: 14, lineHeight: 1.7, color: "var(--muted)", maxWidth: 240 }}>
        ...
        {/* Quick links */}
        <div>
          <h4 style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 20, color: "var(--muted)" }}>
            Quick Links
          </h4>
          {[
            { href: "/", label: "Home" },
        ...
        <div>
          ...
          {[
            ...
            <p key={i} style={{ fontSize: 14, color: "var(--muted)", marginBottom: 10, display: "flex", alignItems: "center", gap: 8 }}>
              <span style={{ color: "var(--blush)" }}>{item.icon}</span>{item.text}
            </p>
          ))}
        </div>
        ...
        <div>
          ...
          {[
            ...
            <div key={h.day} style={{ marginBottom: 10 }}>
              <div style={{ fontSize: 13, color: "var(--muted)" }}>{h.day}</div>
              <div style={{ fontSize: 14, color: "var(--teal)", fontWeight: 600 }}>{h.hours}</div>
            </div>
          ))}
