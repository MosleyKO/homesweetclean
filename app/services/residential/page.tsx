...
import { Home, Sparkles, ArrowRightLeft, CalendarDays, Leaf, ShieldCheck, RefreshCw, MessageCircle, Heart, BadgeCheck } from "lucide-react";
...
const valueCards = [
  ...
  { icon: <Leaf {...valueIconStyle} />, title: "Safe & Eco-Friendly Products", desc: "We use products that are safe for your kids, your pets, and the planet. Clean without compromise." },
  { icon: <ShieldCheck {...valueIconStyle} />, title: "Insured & Background Checked", desc: "Every member of our team is fully insured and background checked. Your home is in safe hands." },
  ...
  { icon: <Heart {...valueIconStyle} />, title: "We Genuinely Care", desc: "This isn't just a job to us. We're passionate about the homes we clean and the families we serve." },
    ...
    <>
      ...
      <section style={{ padding: "60px 32px", background: "var(--cream-warm)", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <h2 className="area-heading" style={{ fontFamily: "var(--font-fraunces), serif", fontSize: "clamp(26px, 3vw, 38px)", fontWeight: 600, color: "var(--teal)", marginBottom: 16 }}>
            Proudly serving{" "}
          ...
          <div className="chips-row" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
